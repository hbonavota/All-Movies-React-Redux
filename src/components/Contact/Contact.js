                ...
                <div className="container">
                    <Card bg='dark' text='light' style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                <span role = "img" aria-label= "emoji">⚡</span>My stack, although not exhaustively given that I am constantly learning, is Html, Css, JS, React, Redux, Node.js, Express, Sql, Sequelize, MongoDB, Postgresql.<br></br>
                                <br></br>
                                <span role = "img" aria-label= "emoji">💬</span> If you are looking for a profile like mine, without a doubt get in touch that I am in an active search!, I will always appreciate your interest. <br></br>
                                <br></br>
                                <span role = "img" aria-label= "emoji">📫</span> Contact: hbonavota@gmail.com
                            </Card.Text>
                            <div className="links">
